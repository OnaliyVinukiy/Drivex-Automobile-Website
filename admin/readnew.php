...
<?php
$vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from new where id =$vid");
$cnt=1;
...
?>
                     ...
                     <div class="col-sm-7" align="right">
                        <a href="editnew.php?editid=<?php echo htmlentities ($row['id']);?>" class="btn btn-primary"><span>Edit Car Details</span></a>
