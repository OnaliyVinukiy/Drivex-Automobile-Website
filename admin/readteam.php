...
<?php
$vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from team where id =$vid");
$cnt=1;
...
?>
                     ...
                     <div class="col-sm-7" align="right">
                        <a href="editteam.php?editid=<?php echo htmlentities ($row['id']);?>" class="btn btn-primary"><span>Edit User Details</span></a>
